...
//    public GameEventExecutorGroup() {
//        this(DEFAULT_MAX_PENDING_EXECUTOR_TASKS);
//    }
    ...
    private static class Holder{
        private static GameEventExecutorGroup INSTANCE = new GameEventExecutorGroup(16);
    }
    public static GameEventExecutorGroup getInstance(){
        return Holder.INSTANCE;
    }
    /**
     * @see #DefaultEventExecutorGroup(int, ThreadFactory)
     */
    private GameEventExecutorGroup(int nThreads) {
        this(nThreads, null);
    }

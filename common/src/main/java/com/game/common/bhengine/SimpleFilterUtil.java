...
//    }
    ...
    public static int checkMeet(Object matterValue,int calType,Object limitValue){
        CalWay calWay = calWayMap.get(calType);
        if (calWay == null){
            return 1;
        }
        return calWay.calMeet(matterValue,limitValue);
    }
